	...
	if (args.length === 0) {
		...
		switch (args[0]) {
			case "help":
				...
				console.log(qp.yi("\tima size <path>") + qp.gb(" - Shows the size of the specified text file, or how much can be written in the image."));
				...
				console.log(qp.yi("\tima run <path>") + qp.gb(" - Run the code from the image"));
				break;
			case "version":
